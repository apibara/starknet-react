...
- an underlying Starknet account which address is derived from the user's EVM address. It can be queried using kakarot core smart contract's method `get_starknet_address(address evm_address)`
