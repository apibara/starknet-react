...
Cartridge Paymaster is natively supported in the Controller. Transactions that match a Paymaster policy will automatically be subsidized. Paymaster policies and budget can be [managed through Slot CLI](https://docs.cartridge.gg/slot/paymaster).
