...
export class InjectedConnector extends Connector {
  ...
  get icon(): ConnectorIcons {
    ...
    let defaultIcon = {
      dark:  this._wallet?.icon || walletIcons[this.id as keyof typeof walletIcons] || WALLET_NOT_FOUND_ICON_DARK,
      light: this._wallet?.icon || walletIcons[this.id as keyof typeof walletIcons] || WALLET_NOT_FOUND_ICON_LIGHT,
    };
