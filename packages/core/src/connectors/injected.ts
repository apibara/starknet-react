...
export class InjectedConnector extends Connector {
  ...
  get icon(): ConnectorIcons {
    ...
    let defaultIcon = {
      dark:  walletIcons[this.name as keyof typeof walletIcons] || WALLET_NOT_FOUND_ICON_DARK,
      light: walletIcons[this.name as keyof typeof walletIcons] || WALLET_NOT_FOUND_ICON_LIGHT,
    };
